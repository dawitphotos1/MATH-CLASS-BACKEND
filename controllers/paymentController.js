...
//       ],
//       mode: "payment",
//       success_url: `${process.env.FRONTEND_BASE_URL || "https://math-class-platform.netlify.app"}/payment-success.html?session_id={CHECKOUT_SESSION_ID}&course_id=${course.id}`,
//       cancel_url: `${process.env.FRONTEND_BASE_URL || "https://math-class-platform.netlify.app"}/payment-cancel.html`,
//       metadata: {
...
export const confirmPayment = async (req, res) => {
  try {
    ...
    if (existing) {
      ...
      console.log("✅ PAYMENT: Created new enrollment");
    }
