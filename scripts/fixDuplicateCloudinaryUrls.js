...
//         console.log(
//           `   ❌ ${lessonsWithSameUrl.length} lessons share the same URL:`
//         );
...
//       console.log(
//         `   ⚠️ Needs new URL (shared with ${
//           lessonsWithSameUrl.length - 1
//         } other lessons)`
//       );
...
//         console.log(
//           `   ✅ Created unique URL: ${result.secure_url.substring(0, 80)}...`
//         );
//         fixedCount++;
...
//         const fallbackUrl = `https://res.cloudinary.com/${
//           process.env.CLOUDINARY_CLOUD_NAME
//         }/raw/upload/v1/mathe-class/pdfs/lesson_${lesson.id}_${Date.now()}.pdf`;
