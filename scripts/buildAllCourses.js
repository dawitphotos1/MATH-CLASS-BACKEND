...
// // Curriculum data based on your courseData.jsx
...
//     ],
//   },
//   // Add other courses here (Algebra 2, Pre-Calculus, Calculus, Geometry, Statistics)
// };
...
//     for (const [courseKey, courseData] of Object.entries(allCoursesData)) {
...
//         unitIndex++
//       ) {
//         const { unit: unitTitle, lessons: lessonTitles } =
...
//         for (
//           let lessonIndex = 0;
//           lessonIndex < lessonTitles.length;
//           lessonIndex++
//         ) {
//           await Lesson.create({
//             course_id: course.id,
...
//           console.log(`      📚 Lesson created: ${lessonTitles[lessonIndex]}`);
//         }
//       }
//     }
...
const buildAllCourses = async () => {
  try {
    console.log("🏗️ Building All 7 Courses...");
    console.log("==========================================");
