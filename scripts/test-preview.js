...
//         `${backendUrl}/api/v1/courses/${courseId}/preview-lesson`
//       );
...
//       if (
//         previewData.lesson?.video_url &&
//         previewData.lesson.video_url.includes("localhost")
//       ) {
...
//       } else {
//         console.log(
//           "✅ SUCCESS: Preview URLs are correctly pointing to Render!"
//         );
//       }
//     }
//   } catch (error) {
