...
// // 🔹 Routes
// import stripeWebhook from "./routes/stripeWebhook.js"; // ✅ new webhook route
...
// // ========================================================
// app.use("/webhook", stripeWebhook); // ✅ handles raw body for Stripe

// // ========== Middleware ==========
// app.use(helmet());
// app.use(cookieParser());
// app.use(express.json()); // ⚠️ must come after webhook
...
// ========================================================
// 🧩 CORS Setup (Fix for localhost + Netlify + Render)
// ========================================================
const allowedOrigins = [
  "http://localhost:3000",
  "http://localhost:3001",
